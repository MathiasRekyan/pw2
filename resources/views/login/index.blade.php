		...
		<div class="row">
			...
			<div class="col-12 col-lg-6 col-md-12"><br /><br /><br />
				<div style="margin: 5% 5% 5% 5%">
					...
					<h1 style="text-align:right; font-size:318%">COOKEASY</h1><br />
					<div class="row justify-content-end">
						<div class="col-12 col-lg-8 col-md-10">
							...
							<main class="form-signin">
								<h1 class="h3 mb-3 fw-normal text-center">Masuk COOKEASY</h1>
								...
								<small class="d-block text-center mt-3">belum pernah mendaftar akun cookeasy ? <br />
