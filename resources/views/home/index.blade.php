...
@section('container')
        ...
        <header class="masthead">
            <div class="container">
                <div class="masthead-subheading">Selamat Datang Di CookEasy<br> yuk coba Resep masakan dari kami !</div>
        ...
        <section class="page-section" id="contact">
            <div class="container">
                <div class="text-center">
                    ...
                    <h5>CE@gmail.com<br/>CE.Facebook<br/>CE.Instagram</h5><br/><br/>
                    <h3 class="section-subheading text-muted">Present By CookEasy.corp</h3>
                </div>
            </div>
        </section>
@endsection